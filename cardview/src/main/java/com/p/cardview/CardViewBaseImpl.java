...
class CardViewBaseImpl implements CardViewImpl {
    ...
    public void initialize(CardViewDelegate cardView, Context context,
        ...
        RoundRectDrawableWithShadow background = createBackground(context, backgroundColor,
                cardView.getShadowStartColor(), cardView.getShadowEndColor(),
                radius, elevation, maxElevation);
    ...
    private RoundRectDrawableWithShadow createBackground(
            Context context, ColorStateList backgroundColor, int shadowStartColor, int shadowEndColor,
            float radius, float elevation, float maxElevation) {
        return new RoundRectDrawableWithShadow(context.getResources(), backgroundColor,
